...
<footer class="bg-white dark:bg-gray-800 w-full py-8">
    <div class="max-w-screen-xl px-4 mx-auto">
        ...
        <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            ...
            <div class="text-center text-slate-500 dark:text-gray-200 pt-10 sm:pt-12 font-normal flex items-center justify-center">
              Copyright 2024 @FruitShop
            </div>
        </div>
    </footer>
